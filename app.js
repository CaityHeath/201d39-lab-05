...
function sum(a, b) { //eslint-disable-line
  var sum = a + b;
  var feedback = 'The sum of ' + a + ' and ' + b + ' is '  + sum + '.';
...
function multiply(a, b) { //eslint-disable-line
  var product = a*b;
  var feedback2 = 'The product of ' +  a + ' and ' + b + ' is ' + product + '.';

  return[product, feedback2];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var feedback1 = a + ' and ' + b + ' and ' + c + ' sum to ' + sum + '.';
  var feedback2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product + '.';
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var feedback = sumArr[0] + ',' + 
                 sumArr[1] + ',' + 
                 sumArr[2] + ' was passed in as an array of numbers, and ' + sumIndices + ' is their sum.';
  
  return[sumIndices, feedback]; 
